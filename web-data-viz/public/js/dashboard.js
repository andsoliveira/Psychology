  ...
  fetch("/quiz/ultimo/" + idUsuario)
    ...
    .then(function (dados) {
      if (dados) {
        ...
        var porcentagemSerotonina = document.getElementById(
        ...
        var mediaQuiz = (serotonina + dopamina + endorfina + ocitocina) / 4;

        var kpi = document.getElementById("kpi_entendimento");
        var texto = document.getElementById("texto_kpi");
...
function criarGrafico(serotonina, dopamina, endorfina, ocitocina) {
  ...
  var dadosGrafico = [serotonina, dopamina, endorfina, ocitocina];
